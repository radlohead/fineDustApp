...
//          es6.object.to-string, es6.function.names and es6.function.has-instance.
// #############################################################################################
...
interface Function {
    /**
      * Returns the names of the function. Function names are read-only and can not be changed.
      */
    name: string;
...
interface Object {
    /**
      * Determines whether an object has a property with the specified names.
      * @param v A property names.
      */
...
interface ArrayConstructor {
    ...
    /**
      * Sorts an array.
      * @param compareFn The names of the function used to determine the order of the elements. If omitted, the elements are sorted in ascending, ASCII character order.
      */
