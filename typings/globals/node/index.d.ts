...
declare module "path" {
    ...
    export interface ParsedPath {
        ...
        dir: string;
        /**
         * The file names including extension (if any) such as 'index.html'
         */
        base: string;
        /**
        ...
        ext: string;
        /**
         * The file names without extension (if any) such as 'index'
         */
        name: string;
    }
    ...
    /**
     * Return the directory names of a path. Similar to the Unix dirname command.
     *
     ...
     * Often used to extract the file names from a fully qualified path.
     *
     * @param p the path to evaluate.
...
declare module "tls" {
    ...
    export class TLSSocket extends stream.Duplex {
        /**
         * Returns the bound address, the address family names and port of the underlying socket as reported by
        ...
        encrypted: boolean;
        /**
         * Returns an object representing the cipher names and the SSL/TLS protocol version of the current connection.
         * @returns {CipherNameAndProtocol} - Returns an object representing the cipher names
